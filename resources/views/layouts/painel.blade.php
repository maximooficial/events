...
{{__('Ultimas Notificações')}}                                </h6>    @foreach($mensagens as $mensagem)
                                ...
                                @foreach($notificacaoeventos as $notificacaoeventos)
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="/img/perfil/{{$notificacaoeventos->avatar}}"
                                            alt="...">
                                        <div class="status-indicator bg-success"></div>
                                    </div>
                                    <div class="font-weight-bold">
                                        <div class="text-truncate">{{$notificacaoeventos->evento_nome}}.</div>
                                        <div class="small text-gray-500">{{$notificacaoeventos->name}}. 58m</div>
                                    </div>
                                </a> @endforeach
                                ...
                                <a class="dropdown-item text-center small text-gray-500" href="{{('notificacoes')}}">Ver Notificações</a>
                            </div>
                        </li>
